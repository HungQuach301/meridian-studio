...
| WP-DOC-001 | [Sửa ba điểm lệch của kế hoạch](work-packages/WP-DOC-001-plan-consistency.md) | 2 | WP-004 | done — chủ dự án nghiệm thu [PR #12](https://github.com/HungQuach301/meridian-studio/pull/12); [CI sau merge](https://github.com/HungQuach301/meridian-studio/actions/runs/34549198224) và [Hello sau merge](https://github.com/HungQuach301/meridian-studio/actions/runs/34549198221) success, attempt 1; [hồ sơ đóng](work-packages/WP-DOC-001-plan-consistency.md#9-hồ-sơ-đóng-wp-doc-001) giữ các giới hạn còn lại |
| WP-004a | **SPIKE: canvas liên tục 6000x3400** — [chuẩn bị PR; runtime đã duyệt; chưa nghiệm thu benchmark](work-packages/WP-004a-canvas-spike.md) | 2 | WP-002 | todo — đã nghiệm thu riêng phục hồi tag của draft 387547778 ngày 2026-09-13; [hồ sơ mục 26](work-packages/WP-004a-canvas-spike.md#26-nghiệm-thu-riêng-phục-hồi-tag-của-draft). Chưa nghiệm thu benchmark hoặc toàn bộ WP-004a. Đã nghiệm thu riêng execution Ready/merge hai tài liệu qua [PR #15](https://github.com/HungQuach301/meridian-studio/pull/15) theo quyết định owner đáp ứng [điều kiện mục 27](work-packages/WP-004a-canvas-spike.md#27-nghiệm-thu-riêng-execution-pr-15); giữ mọi giới hạn và phần chưa nghiệm thu. |
