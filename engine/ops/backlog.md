...
| WP-004a | **SPIKE: canvas liên tục 6000x3400** — [chuẩn bị PR; runtime đã duyệt; chưa nghiệm thu benchmark](work-packages/WP-004a-canvas-spike.md) | 2 | WP-002 | todo — đã nghiệm thu riêng phục hồi tag của draft 387547778 ngày 2026-09-13; [hồ sơ mục 26](work-packages/WP-004a-canvas-spike.md#26-nghiệm-thu-riêng-phục-hồi-tag-của-draft). Chưa nghiệm thu benchmark hoặc toàn bộ WP-004a. |
