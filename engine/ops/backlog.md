...
| WP-004 | Nút dispatch từ UI | 1 | WP-002, WP-003 | in-review — [PR #11](https://github.com/HungQuach301/meridian-studio/pull/11); [đặc tả và phạm vi](work-packages/WP-004-cockpit-dispatch.md); chuẩn bị offline/CI, chưa merge hoặc nghiệm thu lượt dispatch thật |
