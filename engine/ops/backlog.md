...
| WP-004 | Nút dispatch từ UI | 1 | WP-002, WP-003 | in-review — [đặc tả và phạm vi PR](work-packages/WP-004-cockpit-dispatch.md); chuẩn bị offline/CI, chưa merge hoặc nghiệm thu lượt dispatch thật |
